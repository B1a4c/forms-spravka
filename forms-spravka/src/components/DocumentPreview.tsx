...
export const DocumentPreview: React.FC<DocumentPreviewProps> = ({ data, includes }) => {
  const show = {
    uni: includes?.uni ?? true,
    student: includes?.student ?? true,
    leave: includes?.leave ?? true,
    signature: includes?.signature ?? true,
    confirmation: includes?.confirmation ?? data.includeConfirmation
  };
